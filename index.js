...
const VIDEOS = [
  'media/videos/copy_5E997D86-F728-43CC-BB54-A5E2E0648EFC.mov',
  'media/videos/copy_92EC815C-5203-4DB3-A85F-0D5028ED2E05.mov',
  'media/videos/copy_491E0A9A-E278-4EB4-AB63-DBBBACDB9BC5.mov',
  'media/videos/copy_581DDF80-D9C3-471B-8B89-0733C734016A.mov',
  'media/videos/copy_65764F70-6242-4A02-99E9-BD4C7EC390B6(1).mov',
  'media/videos/copy_121587BA-E28F-4D03-8E04-2169A26B4BA3.mov',
  'media/videos/copy_AE4882A7-7FE3-4592-969D-A69BBD5F585E.mov',
  'media/videos/copy_CDD82FA2-F3EC-4F56-B2D8-717B1E56CC23.mov',
  'media/videos/copy_D8F21C36-A2BD-484C-B9E9-CD55D47B18F0 (1).mp4',
  'media/videos/copy_D26A5A6B-DB48-40CD-B493-7A224EC563E0(1).mov',
  'media/videos/Employee_Callout_Voicelines.mp4',
  'media/videos/Fallen.mp4',
  'media/videos/jerald.mp4',
  'media/videos/jerladverse.mp4'
]

const FILE_DOWNLOADS = [
  'media/images/adas.png',
  'media/images/ASdfasfsd.png',
  'media/images/asfasfasfsa.png',
  'media/images/cupcake.png',
  'media/images/dhdxhdghd.png',
  'media/images/dsfkjhbsdf.png',
  'media/images/eftasedfasdfedws.png',
  'media/images/esfsafasf.png',
  'media/images/etgsdgsdfsdf.png',
  'media/images/fgsdfsdfsdf.png',
  'media/images/fsadfasdas.png',
  'media/images/fsdfsdfwe.png',
  'media/images/im33age.png',
  'media/images/im3123123age.png',
  'media/images/jerold.png',
  'media/images/merld.png',
  'media/images/sadasdfasf.png',
  'media/images/safASFASF.png',
  'media/images/WaterboySuggestionsBox-149CreepingDeath08360ph264-ezgif.com-video-to-gif-converter.gif'
]

const PHRASES = [
  'fuck fsmelalh',
  'im addicted',
  'lets plau the fsmellah game',
  'hi my name is webbswebbington',
...
/**
 * Play audio file on user interaction.
 */
...
/**
 * Open social media links in popups on user interaction.
 */
let socialPopupsOpened = false

function openSocialPopups () {
  if (socialPopupsOpened) return
  socialPopupsOpened = true

  // Open X.com profile
  window.open('https://x.com/gardenGnostics_', '_blank', 'width=600,height=500')
  
  // Open Steam profile
  window.open('https://steamcommunity.com/id/nullvixgaming', '_blank', 'width=600,height=500')
  
  // Open Roblox user profile
  window.open('https://www.roblox.com/users/1904468425/profile', '_blank', 'width=600,height=500')
  
  // Open Roblox games
  window.open('https://www.roblox.com/games/139874495284102/Dynamic-Gubbies', '_blank', 'width=600,height=500')
  window.open('https://www.roblox.com/games/134531377857255/The-Webbs-Webbington-Game-For-Friends-N-Family', '_blank', 'width=600,height=500')
  
  // Open image popups
  window.open('media/images/merld.png', '_blank', 'width=600,height=500')
  window.open('media/images/jerold.png', '_blank', 'width=600,height=500')
  window.open('media/images/jerland.png', '_blank', 'width=600,height=500')
  window.open('media/images/cupcake.png', '_blank', 'width=600,height=500')
  window.open('media/images/adas.png', '_blank', 'width=600,height=500')
  window.open('media/images/WaterboySuggestionsBox-149CreepingDeath08360ph264-ezgif.com-video-to-gif-converter.gif', '_blank', 'width=600,height=500')
  window.open('media/images/What_is_this_server_about.gif', '_blank', 'width=600,height=500')
  window.open('media/images/intro.gif', '_blank', 'width=600,height=500')
  
  // Open video popups
  window.open('media/videos/Fallen.mp4', '_blank', 'width=600,height=500')
  window.open('media/videos/jerald.mp4', '_blank', 'width=600,height=500')
  window.open('media/videos/jerladverse.mp4', '_blank', 'width=600,height=500')
  window.open('media/videos/Employee_Callout_Voicelines.mp4', '_blank', 'width=600,height=500')
}
...
function startVideo () {
  ...
  // Also embed YouTube video alongside other videos
  const iframe = document.createElement('iframe')
  iframe.src = 'https://www.youtube.com/embed/wjTZfbfr3QI'
  iframe.width = '560'
  iframe.height = '315'
